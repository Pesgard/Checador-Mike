"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\thech\\.cursor\\extensions\\wallabyjs.console-ninja-1.0.451\\out\\buildHook\\index.js').default({tool: 'nest.js', checkSum: '2058d6e6b47981d07f6473BAlKBksDWAxVX1tSXFFVBAVXAAUM', mode: 'runtime'}); } catch(cjsError) { try { import('file:///c:/Users/thech/.cursor/extensions/wallabyjs.console-ninja-1.0.451/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '2058d6e6b47981d07f6473BAlKBksDWAxVX1tSXFFVBAVXAAUM', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
